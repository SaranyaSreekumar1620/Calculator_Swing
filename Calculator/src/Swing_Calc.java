...
public class Swing_Calc implements ActionListener
{
	...
	public Swing_Calc()
	{
		...
		displayLabel.setBounds(36, 56, 515, 50);
		...
		dotButton.setFont(new Font("Arial",Font.PLAIN,70));
		jf.add(dotButton);
		...
		zeroButton.setFont(new Font("Arial",Font.PLAIN,80));
		jf.add(zeroButton);
		...
		divButton.setFont(new Font("Arial",Font.PLAIN,70));
		jf.add(divButton);
		...
		mulButton.setFont(new Font("Arial",Font.PLAIN,80));
		jf.add(mulButton);
		
		subButton=new JButton("-");
		subButton.setBounds(330, 330, 80, 80);
		subButton.addActionListener(this);
		subButton.setFont(new Font("Arial",Font.PLAIN,80));
		jf.add(subButton);
